  ...
  return (
    <article className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="bg-primary/5 p-8 rounded-2xl border border-primary/10 space-y-4">
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <li className="space-y-2">
              <h4 className="font-black uppercase text-xs tracking-widest text-primary">A prueba de crisis</h4>
            ...
            <li className="space-y-2">
              <h4 className="font-black uppercase text-xs tracking-widest text-primary">No se inventa</h4>
        ...
        <div className="bg-primary/60 text-primary-foreground p-8 rounded-2xl space-y-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left space-y-1">
              ...
              <p className="text-[10px] uppercase font-bold opacity-60 tracking-widest">Para insumos y gastos externos</p>
            </div>
            ...
            <div className="text-center md:text-left space-y-1 text-primary">
              ...
              <p className="text-[10px] uppercase font-bold opacity-60 tracking-widest">Aceptación mínima necesaria</p>
            </div>
          </div>
          <p className="text-xs opacity-70 text-center font-bold uppercase tracking-widest italic">
      ...
      <section className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-foreground/80 font-medium">
          Como compañeros, tenemos la libertad de negociar pagos de hasta el 100% en Túmin según nuestras necesidades.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-4 bg-background/50">
            <h4 className="font-black uppercase text-[10px] tracking-widest text-primary mb-2">Servicios</h4>
            <p className="text-xs text-foreground/70">Ideal para cobrar 100% Túmin ya que tu principal inversión es tu tiempo.</p>
          </Card>
          <Card className="p-4 bg-background/50">
            <h4 className="font-black uppercase text-[10px] tracking-widest text-primary mb-2">Segunda Mano</h4>
            <p className="text-xs text-foreground/70">Artículos que ya no usas pueden capitalizarse totalmente en la red.</p>
          </Card>
          <Card className="p-4 bg-background/50">
            <h4 className="font-black uppercase text-[10px] tracking-widest text-primary mb-2">Excedentes</h4>
            <p className="text-xs text-foreground/70">Fruta de temporada o excedentes de producción son perfectos para la red.</p>
          </Card>
        </div>
      </section>
