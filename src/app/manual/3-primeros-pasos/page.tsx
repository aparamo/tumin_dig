    ...
    <article className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <section className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-foreground/80 font-medium">
          El Túmin Digital es una <strong>App Web Progresiva (PWA)</strong>. No necesitas buscarla en la Play Store o App Store; se instala directamente desde tu navegador.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 space-y-4 border-2 border-primary/10">
            ...
            <ol className="text-xs space-y-2 text-foreground/70 list-decimal pl-4">
          ...
          <Card className="p-6 space-y-4 border-2 border-primary/10">
            ...
            <p className="text-xs text-foreground/70">Simplemente guarda la dirección en tus &quot;Favoritos&quot; o &quot;Marcadores&quot; para acceso rápido.</p>
          </Card>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex gap-4 p-4 border rounded-xl bg-orange-500/5 border-orange-500/20">
            ...
            <div>
              <h4 className="font-black uppercase text-xs tracking-widest text-orange-600 mb-1">Color Naranja</h4>
          ...
          <div className="flex gap-4 p-4 border rounded-xl bg-green-500/5 border-green-500/20">
            ...
            <div>
              <h4 className="font-black uppercase text-xs tracking-widest text-green-600 mb-1">Color Verde</h4>
        ...
        <div className="bg-primary text-primary-foreground p-8 rounded-2xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
            <div className="bg-background/10 p-4 rounded-lg">
              ...
              <p className="text-xs font-bold mt-1">Publicar Producto</p>
            </div>
            <div className="bg-background/10 p-4 rounded-lg">
              <span className="text-[10px] font-black uppercase tracking-widest opacity-60">Paso 2</span>
              <p className="text-xs font-bold mt-1">Recibir Bono <strong>25 Ŧ</strong></p>
            </div>
            <div className="bg-background/10 p-4 rounded-lg">
              <span className="text-[10px] font-black uppercase tracking-widest opacity-60">Paso 3</span>
              <p className="text-xs font-bold mt-1">Desbloquear Minado</p>
            </div>
          </div>
        </div>
      </section>
